...
:map <LocalLeader>jsc :call ShowSetupEvnironmentWindow('cscope')<CR>
"Show tags setup window
:map <LocalLeader>jst :call ShowSetupEvnironmentWindow('tags')<CR>
"Create ctags and cscope database
:map <LocalLeader>jc :call DatabaseCreate ()<CR>
"}}}
