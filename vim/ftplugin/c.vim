...
noremap    <buffer>  <silent>  <LocalLeader>li         :call C_InsertTemplate("idioms.plog_info")<CR>
noremap    <buffer>  <silent>  <LocalLeader>ld         :call C_InsertTemplate("idioms.plog_debug")<CR>
noremap    <buffer>  <silent>  <LocalLeader>lw         :call C_InsertTemplate("idioms.plog_warn")<CR>
noremap    <buffer>  <silent>  <LocalLeader>le         :call C_InsertTemplate("idioms.plog_error")<CR>
noremap    <buffer>  <silent>  <LocalLeader>lf         :call C_InsertTemplate("idioms.plog_fatal")<CR>
